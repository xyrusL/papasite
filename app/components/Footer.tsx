...
export default function Footer() {
    return (
        <footer id="contact" className="border-t border-white/10 text-gray-300 py-8 font-sans">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6 md:gap-0">
                    ...
                    >
                        <a
                            ...
                            className="glass-focus group flex items-center gap-3 text-blue-400 hover:text-blue-300 transition"
                        >
            ...
            <motion.div
                className="glass-surface glass-surface-soft mt-8 pt-6 pb-4 border-t border-white/10 rounded-2xl flex flex-col sm:flex-row justify-between items-center text-xs text-gray-400 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8"
                initial={{ opacity: 0 }}
