    ...
    return (
        <div id="hero" className="relative min-h-screen flex items-center justify-center pt-24 pb-12 overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full flex flex-col items-center justify-center">
                ...
                <motion.div
                    className="bg-black/40 backdrop-blur-xl p-8 sm:p-10 rounded-3xl border border-white/10 mb-12 max-w-3xl w-full shadow-2xl relative overflow-hidden group"
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 pt-6 border-t border-white/5">
                ...
                >
                    <a
                        ...
                        className="group flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-10 rounded-full transition-all duration-300 transform hover:scale-105 shadow-[0_0_20px_rgba(37,99,235,0.5)] hover:shadow-[0_0_35px_rgba(37,99,235,0.7)] text-lg"
                    >
